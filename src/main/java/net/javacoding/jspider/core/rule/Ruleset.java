...
/**
 * Interface of a RuleSet, a set of Rules that will be applied as a group on
 * URLs.
 *
...
public interface Ruleset {
	 ...
	 * @return Decision object expressing the ruleset's decision about the given
	 * url in the given context.
	 */
