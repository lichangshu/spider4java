...
public class DistributedLoadThrottleImpl implements Throttle {
	...
	/**
	 * Constructor taking the amount of milliseconds to wait between two
	 * subsequent requests as a parameter.
	 *
	...
	/**
	 * This method will block spider threads until they're allowed to do a
	 * request.
	 */
