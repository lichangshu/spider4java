...
/**
 * Factory class that is responsible to create Throttle component instances for
 * use by the engine.
 *
 * <p>
 * Since we use a pluggable component setup, the throttle provider class and the
 * parameters used by the throttle component implementation are stored in the
 * jspider.properties file, under the conf/ folder, in the subfolder of the used
 * configuration.
 * </p>
 *
