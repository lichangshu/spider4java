...
/**
 * Interface that should be implemented by each Throttle provider class. This
 * allows for pluggable provider classes to be referenced from the configuration
 * files.
 *
