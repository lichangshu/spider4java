...
/**
 * Interface that will be implemented upon each class that represents a JSpider
 * workertask that needs to be executed by a Worker Thread.
 *
 * JSpider has two types of tasks: spider tasks (that fetch data from a web
 * server), and thinker tasks (that interpret data, take decision, etc...)
 *
