 ...
 * scheduler. The Task scheduler will keep track of all work that is being done
 * and all tasks that still have to be carried out.
 *
...
public interface Scheduler {
	...
	/**
	 * Block a task for a certain siteURL. This is used to block any resource
	 * handling for a site for which we didn't interpret the robots.txt file
	 * yet.
	 *
	...
	/**
	 * Returns all tasks that were blocked for the specified site, and removes
	 * them from the blocked resources pool.
	 *
	...
	/**
	 * Flags a task as done. This way, we are able to remove the task from the
	 * in-process list.
	 *
