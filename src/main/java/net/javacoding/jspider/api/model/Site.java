...
public interface Site {
	...
	/**
	 * if the site is newly discovered, we're not going to fetch resources until
	 * we have interpreted the site's robots.txt rules.
	 */
	public static final int STATE_DISCOVERED = 0;

	/**
	 * if the robots.txt was handled (interpreted or missing), we can fetch
	 * resources from it.
	 */
