...
/**
 * Interface to be implemented upon classes that will represent a DesisionStep,
 * a step in the process of the decision taking on a resource URL whether it
 * should be spidered and/or parsed.
 *
...
public interface DecisionStep {
	...
	/**
	 * The decision that was taken by the rule (DONTCARE, ACCEPT, IGNORE,
	 * FORBIDDEN)
	 *
	...
	/**
	 * Returns any comment or explanation given by the rule about it's
	 * explanation
	 *
