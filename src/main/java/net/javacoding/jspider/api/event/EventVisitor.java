...
/**
 * Visitor interface that must be implemented upon each class that will act as a
 * visitor in the applied visitor pattern for event handling. This interface
 * contains a visit method for each JSpider API event type.
 *
