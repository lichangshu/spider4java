...
public class WorkerThreadPoolTest extends TestCase {
	...
	/**
	 * Test the instantiation and the stopping of all worker threads that are
	 * grouped in a pool.
	 */
	...
	/**
	 * Tests the dispatcher thread functionality. Dispatch some tasks and see if
	 * all threads die smoothly in time and the occupation of the pool is 0%
	 * afterwards.
	 */
	...
	/**
	 * Test method that tests the raw Thread Pool (without dispatcher). Small
	 * set.
	 */
	...
	/**
	 * Test method that tests the raw Thread Pool (without dispatcher). large
	 * set.
	 */
	...
	/**
	 * Uses the ThreadPool (with dispatcher thread). Small test set.
	 */
	...
	/**
	 * Uses the ThreadPool (with dispatcher thread). Large test set.
	 */
